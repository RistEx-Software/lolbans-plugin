 ...
 */
public abstract class RistExCommandAsync implements CommandExecutor
{   
    ...
    public final boolean onCommand(CommandSender sender, Command command, String label, String[] args)
	{
		...
		FutureTask<Boolean> t = new FutureTask<>(new Callable<Boolean>() 
		{
			...
			public Boolean call()
			{
				if (!self.Execute(sender, command, label, args))
					self.onSyntaxError(sender, command, label, args);
				return true;
			}
		});
